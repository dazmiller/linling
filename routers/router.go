...
func init() {
	...
	beego.Router("/test", &controllers.HomeController{}, "get:Prod")

	beego.Router("/test2", &controllers.HomeController{}, "get:Prod2")
	beego.Router("/test3", &controllers.HomeController{}, "get:Prod3")
	beego.Router("/test4", &controllers.HomeController{}, "get:Cart")
	...
	beego.Router("/msg/:id", &controllers.QuoteMessagesController{}, "get:GetOne")
	beego.Router("/qtcon/:id", &controllers.QuoteContactRequestsController{}, "get:GetOne")

	beego.Router("/life_products", &controllers.ProductsLifeController{}, "get:GetAll")
